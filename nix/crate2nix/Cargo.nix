  ...
  internal = rec {
    ...
    crates = {
      ...
      "cargo" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "0h3nl44di7y1azxmwdnd8hizl2z66rajvjj637w88yzidw3zbgsc";
      ...
      "dashmap" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "parking_lot_core 0.9.5";
          }
        ];
        features = {
          "rayon" = [ "dep:rayon" ];
      ...
      "openssl" = rec {
        ...
        version = "0.10.44";
        edition = "2018";
        sha256 = "0rhmpsixj8hhkw2amhmxmlng5lk7ma0nw3r6fwww5zi2azyp3n99";
        authors = [
          "Steven Fackler <sfackler@gmail.com>"
        ];
        dependencies = [
      ...
      "openssl-sys" = rec {
        ...
        version = "0.9.79";
        edition = "2015";
        sha256 = "1i6brgcdjm38z0hgsrigh1k2wdnsr2mkd4605rzyklff1qn4cm2l";
        build = "build/main.rs";
        authors = [
          "Alex Crichton <alex@alexcrichton.com>"
          "Steven Fackler <sfackler@gmail.com>"
      ...
      "parking_lot_core 0.9.5" = rec {
        crateName = "parking_lot_core";
        version = "0.9.5";
        edition = "2018";
        sha256 = "1fnr5rdb2zr4w8cmd8lmfhnzg3xk9ijysdamjk2kx2lnygzg7ybz";
        authors = [
          "Amanieu d'Antras <amanieu@gmail.com>"
        ];
        dependencies = [
      ...
      "pest" = rec {
        ...
        version = "2.5.1";
        edition = "2021";
        sha256 = "1l79whw28qajiq2brjzfhpqcv8iph80w1xwblyib1yg094syv2yc";
        authors = [
      ...
      "pest_derive" = rec {
        ...
        version = "2.5.1";
        edition = "2021";
        sha256 = "0i13nf9h50m86c78n9xdp8yx9daav0ch33r3xpa91zq61mh7ih6d";
        procMacro = true;
        authors = [
          "Dragoș Tiselice <dragostiselice@gmail.com>"
        ];
      ...
      "pest_generator" = rec {
        ...
        version = "2.5.1";
        edition = "2021";
        sha256 = "0g6jpv8i82xyyxndklilzxma6blfzw67ash0d6r8n564n5haz898";
        authors = [
          "Dragoș Tiselice <dragostiselice@gmail.com>"
        ];
        dependencies = [
      ...
      "pest_meta" = rec {
        ...
        version = "2.5.1";
        edition = "2021";
        sha256 = "082g82sagzygm7vhgkn02wh76scpg9y0rz5fq73f0apwb5fn1j7y";
        authors = [
          "Dragoș Tiselice <dragostiselice@gmail.com>"
        ];
        dependencies = [
      ...
      "serde_ignored" = rec {
        ...
        version = "0.1.6";
        edition = "2018";
        sha256 = "192l9msvbyqlvk97b4x60dzw36p2zzyn0n7gg0ykay0p2yv2w8ai";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "toml_edit 0.14.4" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "easy" "kstring" "perf" "serde" ];
      };
      "toml_edit 0.6.0" = rec {
        crateName = "toml_edit";
        version = "0.6.0";
      ...
      "windows-sys 0.42.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Security" "Win32_Security_Authorization" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_LibraryLoader" "Win32_System_SystemServices" "Win32_System_WindowsProgramming" "default" ];
      };
