...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "541ae5b1e20ad74e33c2fb68aa8d264849a6ee08";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-541ae5b1e20ad74e33c2fb68aa8d264849a6ee08/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "3dfc78e42a285caaf83633224a42e7fb7dde191b";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "3dfc78e42a285caaf83633224a42e7fb7dde191b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-KTBvUmhMfyUwbbpo5QIcUlIpUOkIaL9Ixpcnch6o2jM=";
    };
  };
}
