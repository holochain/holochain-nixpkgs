...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "7c3c80ed1188703899759d3dc4146453616f5509";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-7c3c80ed1188703899759d3dc4146453616f5509/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "31aa631dbc496500efd2507baaed39626f6650f2";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/31aa631dbc496500efd2507baaed39626f6650f2.tar.gz";
      sha256 = "08qaraj9j7m2g1ldhpkg8ksylk7s00mr7khkzif0m8jshkq8j92b";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "d950f21d1a8d97ec49aff19f191632aa74f3a5d7";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-NDtx7Rn6E/y82O+LjzKhc0kZRAO5pmuuRfgN0Nj7uKs=";
    };
  };
}
