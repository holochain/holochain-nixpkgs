...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "512b62874f3e2c228c8a5516ae0db2ab1c1954b8";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-512b62874f3e2c228c8a5516ae0db2ab1c1954b8/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "3034ea450bdd5c2f7d9a8b2d7fd7c258f09113e7";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-UkH8lVSlNX22apOqnuyEtQPtuhL+XOPWQVG5dsgLamA=";
    };
  };
}
