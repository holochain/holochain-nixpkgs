...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "f089da580fa7962e7b243cb57c47c052a4cc5dac";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-f089da580fa7962e7b243cb57c47c052a4cc5dac/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "0461a5124276c6a314f63d5ec1f6b653a53289b3";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/0461a5124276c6a314f63d5ec1f6b653a53289b3.tar.gz";
      sha256 = "0izh0qi41ay5qzffq2h53kpbiblh4djpvx86snfkbw6n1z5hlgax";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "684659b7ca903e512a421bc6ade689fb26e509b4";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-zUldhyWANdgko+lqQuB1Eee7TyYya1KiOS0SCd/Y268=";
    };
  };
}
