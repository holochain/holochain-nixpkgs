...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "600c61b2f91d62fe93b6bba9a7f959f20c87c421";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-600c61b2f91d62fe93b6bba9a7f959f20c87c421/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "5d3976195b04db1d33adf7528f7a3c8a66b9f818";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/5d3976195b04db1d33adf7528f7a3c8a66b9f818.tar.gz";
      sha256 = "1yr4528p18lfbrdawd5f0rlniq73hmyccvvz36kknh4g5lfywxsn";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "a785c5db0ab1b10e6ba04b7240628aea9615e9ad";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-EYzGCJaTNTSbUk5sa2i4/dn71YtE6uvZb9syL8GH1U0=";
    };
  };
}
