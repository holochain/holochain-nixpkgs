...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "9b2b53deb78f2c05e0e39e196c1e30b72fa9193a";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-9b2b53deb78f2c05e0e39e196c1e30b72fa9193a/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "4cde5389706db0ac0a9b2411e57a142a8ce34617";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-4cde5389706db0ac0a9b2411e57a142a8ce34617/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "511f6a5c3248f9019a41e70c1891484de2bc906c";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/511f6a5c3248f9019a41e70c1891484de2bc906c.tar.gz";
      sha256 = "1zipqa6vr44k30wapvj918mdj009hyhfczphvsymphrmllxiy8va";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "fef2c0b46d506acd782309bbecd0ea12eb6f0048";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "fef2c0b46d506acd782309bbecd0ea12eb6f0048";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-WbFhr4tc6HzqTNNxwGmHonFl4CZidnBwUFhFKy80pQs=";
    };
  };
}
