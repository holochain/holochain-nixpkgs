...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "50a78eb50f20b0a6d66e6d197a345bce07dadd07";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-50a78eb50f20b0a6d66e6d197a345bce07dadd07/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "88813d781247c9db4d254063a604c22813013af5";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-88813d781247c9db4d254063a604c22813013af5/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "a1fe662eb26ffc2a036b37c4670392ade632c413";
    src = fetchTarball {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c82cd893b40dc858f91bce11a9e19ee11db86721";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c82cd893b40dc858f91bce11a9e19ee11db86721";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-BCMsSZIXJumY3RROgrIIu/fw3pNISCTqcmb7/UxGx88=";
    };
  };
}
