...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_main = {
    ...
    version = "0604df99ff7963466c0c4d73e53023f5ad28fbbd";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-0604df99ff7963466c0c4d73e53023f5ad28fbbd/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "fb4d8ee5220b76d1ffb4b4e1fedcf3cbc93ead1a";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-b6Tnu74VzdMaJgKHM9iJ6fVf9svzYI+ktfzMGoDt/Og=";
    };
  };
}
