...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "2646c5c4621523b46e23e2fec223cb43dbe7ae97";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-2646c5c4621523b46e23e2fec223cb43dbe7ae97/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "3e49d501ce1b74a700d5abae9b8b26021885f012";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-3e49d501ce1b74a700d5abae9b8b26021885f012/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "b5b5d05370e287f5e87db1cfa176d7915728fa90";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/b5b5d05370e287f5e87db1cfa176d7915728fa90.tar.gz";
      sha256 = "0bp0dlbaf4a7cy6gk7lapix36wlhm8ncpjda3am1igzl94xak3f7";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c7d9566796b3ad5b257e187e1628488c7429b89e";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-HdXvdU+wV+E1nNzG2vaQsUuBJQID3AB3BX88N8lA37M=";
    };
  };
}
