...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "9b1e185737e1581afc108340b6c64f5686db8314";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-9b1e185737e1581afc108340b6c64f5686db8314/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "093573bc629fb323f5eac51662bc853d26bb2696";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "093573bc629fb323f5eac51662bc853d26bb2696";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4fiTatBwqWOBdeA/r28pNC4PJVW0R0JgpUD+D7GsNcI=";
    };
  };
}
