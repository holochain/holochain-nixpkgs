...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_main = {
    ...
    version = "b008b897f59fbdfeda28a116554fc39f7359c198";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-b008b897f59fbdfeda28a116554fc39f7359c198/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "13c15a84ffa02c5dd288f2398cd6eaf107d16dc5";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/13c15a84ffa02c5dd288f2398cd6eaf107d16dc5.tar.gz";
      sha256 = "0m90jhlrgwgyvd966d0c7fql85ann2v87q9ir3xrfkvipd89zqnd";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "21702ad0206584057b8458fb6c7292c5f94fc618";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "21702ad0206584057b8458fb6c7292c5f94fc618";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-NZ04S9DsD5YmWZLrC1fmLX/LrM3sXEmxsdOzt5Qt0o8=";
    };
  };
}
