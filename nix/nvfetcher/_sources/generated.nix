...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "7ea416afeba5eed54d7ac68917ca2214859ebd07";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-7ea416afeba5eed54d7ac68917ca2214859ebd07/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "f7ff004c0925cf19a52d90ff7f8df8ec6d8f170a";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-f7ff004c0925cf19a52d90ff7f8df8ec6d8f170a/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "46af3303651699dc58cfc251d9b18c0f59d857da";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/46af3303651699dc58cfc251d9b18c0f59d857da.tar.gz";
      sha256 = "15q77x52vyda179hsaybb01xxs27bhy9jdvhinsad7x2faikbvy5";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "ae5bc6cdb2683885de4c3f3a6433d68203b5da9c";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "ae5bc6cdb2683885de4c3f3a6433d68203b5da9c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-MOhGElV3SR5k2BptTErKib73ckmo/mdvTvzh4X1AAp4=";
    };
  };
}
