...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "082ee1cd2bf14a5960604ca01ef369c143360bc0";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-082ee1cd2bf14a5960604ca01ef369c143360bc0/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "148815c92641976b798efb2805a50991de4bac7f";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-v0DBElK+PmU3ID9/uHwtCNHp6uGuWmxj6/elpq4Cqas=";
    };
  };
}
