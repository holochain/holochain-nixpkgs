...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "bce6d15455f8c15c9ef511368947e7ef789c5316";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/bce6d15455f8c15c9ef511368947e7ef789c5316.tar.gz";
      sha256 = "0lic5cai6nimmn7blv85dxh0423mi5vnw58jzckh36pbsbqjpm4k";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "43b487fe27859e1534d2a9094a9095e0291b1996";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "43b487fe27859e1534d2a9094a9095e0291b1996";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-yhVC/DXuTLE26GJFpokUgMDiPS02ClyhlMoiqkOf2x4=";
    };
  };
}
