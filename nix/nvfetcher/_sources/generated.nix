...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "c3f286bf567abb7f425d8503c8f3eb0440ffeaaf";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-c3f286bf567abb7f425d8503c8f3eb0440ffeaaf/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "c132d0837dfb9035701dcd8fc91786c605c855c3";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/c132d0837dfb9035701dcd8fc91786c605c855c3.tar.gz";
      sha256 = "1lych1zri57kqs9v5253rakkkq2f6cx25z24is59xz6x0n4znw6y";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c095030cf6c84e304f867ad066d8d5b051131af5";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-gmSmf3bDS9oR4OHsvKHEErqje228XXP22uKIQWZj4Jo=";
    };
  };
}
