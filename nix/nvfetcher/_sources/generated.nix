...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "74a9ac250285d38985fad9d41de3955646549606";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-74a9ac250285d38985fad9d41de3955646549606/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "b099eaa0e01a45fc3459bbe987c3405c425ef05c";
    src = fetchTarball {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "90a7228c33be0ef7f8a10fafa83ced9aaa09afa4";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "90a7228c33be0ef7f8a10fafa83ced9aaa09afa4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-mGO/X5IHUNdh50aw/2zuPDiXEFbf+HHryK8bIODPpyo=";
    };
  };
}
