...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "fa8bc795b643faecc2d400b90714fd7d00a8d179";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-fa8bc795b643faecc2d400b90714fd7d00a8d179/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "f34d44aef4ca7c11e66ed30ef46a93058a578c0f";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-CvuR+v3FClg/En4LDdLOhLQApAZ9xZZaxeDadfwIBkw=";
    };
  };
}
