...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "0c8865b034061980d82ea499fcff848f482b743e";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-0c8865b034061980d82ea499fcff848f482b743e/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "746b76a3caa09cb045824d534c3453214c39c453";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-746b76a3caa09cb045824d534c3453214c39c453/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "b5991e4971523a5fcc9413b9003b58e5c15aa7d8";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/b5991e4971523a5fcc9413b9003b58e5c15aa7d8.tar.gz";
      sha256 = "1zqnpiqqwfn0jqqhmz0km0xyfq5rdw9drrxpd9q2rah65di09s76";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "0d86c6304c3ca3617ba486cf48a4d23111d94cc2";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "0d86c6304c3ca3617ba486cf48a4d23111d94cc2";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-RDsRvg2fdTBi0ic4UuqhVSgubDnhfrQxxpjmGX3rTD0=";
    };
  };
}
