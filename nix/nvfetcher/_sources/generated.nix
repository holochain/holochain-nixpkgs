...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "e00694e99419b4f028aa06bc674da58d65ff33b1";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-e00694e99419b4f028aa06bc674da58d65ff33b1/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "64286bf7aa10e9e93032361a69843daa354fdb1b";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-64286bf7aa10e9e93032361a69843daa354fdb1b/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "aac972f178eda84a7a7ec8a698bc7bbf43642be5";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/aac972f178eda84a7a7ec8a698bc7bbf43642be5.tar.gz";
      sha256 = "0lcpgfqlhnqggjj3mkppxhpzcqsz4i4ybqfc8qp6a33m94mgp48m";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "eca2f757838f162bbe000443fc5f02b6993774e1";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "eca2f757838f162bbe000443fc5f02b6993774e1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-0cqpkQ0HLhS8UYI8ILKkgrdDH3jWUbOgxvyo9fLXOoY=";
    };
  };
}
