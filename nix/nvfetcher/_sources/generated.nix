...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "3e1c4c64b843b9e5241d7e15922e1fa30fd6e720";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-3e1c4c64b843b9e5241d7e15922e1fa30fd6e720/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "fd76032706405b6abe09bff25ca7e28ac1fa0043";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-WjyKSpFY44ysIHSN3C0L5PKUJuwXDnSg6p5OcYwbZZ4=";
    };
  };
}
