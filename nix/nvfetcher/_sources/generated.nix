...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "71f89b928ff9fa4ee43c6464c75a7c85e5e8348e";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-71f89b928ff9fa4ee43c6464c75a7c85e5e8348e/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "ee7242f9aa014f1024cf90401b0a4d136b59323f";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-ee7242f9aa014f1024cf90401b0a4d136b59323f/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "eb01c16236ec4946834610417450ab77afc8a6ff";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/eb01c16236ec4946834610417450ab77afc8a6ff.tar.gz";
      sha256 = "0sx8n6b95p5h7jw7mba93haw2vmixyq3nqzdhp6806pmv7qxnvfk";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "89bc2470e961048669227c041458b878f2e5fa56";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "89bc2470e961048669227c041458b878f2e5fa56";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-agxkWcTFdMNHJ28kmHOHtKbjI/Svxigi7SjQU0rjoRI=";
    };
  };
}
