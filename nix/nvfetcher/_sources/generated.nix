...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "83ac87d485d941118d4f7c31cc03da56b4446cc2";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-83ac87d485d941118d4f7c31cc03da56b4446cc2/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "859b5732431d23f1c2b16e22fc3fe7419a2f46e2";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-859b5732431d23f1c2b16e22fc3fe7419a2f46e2/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "9652ef34c7439eca9f86cee11e94dbef5c9adb09";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-aLYwYVnrmEE1LVqd17v99CuqVmAZQrlgi2DVTAs4wFg=";
    };
  };
}
