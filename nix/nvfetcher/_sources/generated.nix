...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "29f7cf536c030c5d79c6595f4bdbcb0c61c3b9d1";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-29f7cf536c030c5d79c6595f4bdbcb0c61c3b9d1/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "5be0c1633a6f99dfefdca0aad665c941a7b769aa";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "5be0c1633a6f99dfefdca0aad665c941a7b769aa";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-e/17Hr+zWlNJlcuaNxHNGwlzqF+IJu7NWoKYFJj4kZU=";
    };
  };
}
