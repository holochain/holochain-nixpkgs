...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "3b527d1df8a68b71bc11623fd1ab6e5c686afb8a";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-3b527d1df8a68b71bc11623fd1ab6e5c686afb8a/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "0300688a98e053712108d4e22d5bdcf9c9106d8c";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-aKdxkiYUGuvgy+eKq4jubf/gZN7TBoF6huE4w0chhDE=";
    };
  };
}
