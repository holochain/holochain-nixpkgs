...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "d75883c675de03ef3a45fba001164b2c0e1ee1f6";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-d75883c675de03ef3a45fba001164b2c0e1ee1f6/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c73b7bd9e921e126311ffe14929498585cef9243";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c73b7bd9e921e126311ffe14929498585cef9243";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-X9HZAEcIeTA3eAlKrAqMBAddkssZNgSa5fBg1CbwLLk=";
    };
  };
}
