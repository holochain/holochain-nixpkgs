...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "a731dbf786a0e4d4f77e7e647678894c7c0115d2";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-a731dbf786a0e4d4f77e7e647678894c7c0115d2/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "c9a1090e19f93cb30c205682aab2d0989f8de91f";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/c9a1090e19f93cb30c205682aab2d0989f8de91f.tar.gz";
      sha256 = "11rc53q33w9p28rxx7z662ynhhmhkmgrz1f3azhmmlig3jch8hsw";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c468d43da4b41740e75153b001c81c5e2ed5a3c9";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c468d43da4b41740e75153b001c81c5e2ed5a3c9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-YFYCTwnB60MCZ1LkQn+KIaGft1BsYAPTpoihyjE7ZWM=";
    };
  };
}
