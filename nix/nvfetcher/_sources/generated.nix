...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "7609d0b89cb35a29b1646c29e16b3fa04067ded3";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-7609d0b89cb35a29b1646c29e16b3fa04067ded3/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "60779b2fde21d3d48bc1999fc0ce6540eba07924";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/60779b2fde21d3d48bc1999fc0ce6540eba07924.tar.gz";
      sha256 = "125wk95rp1zn2g8mm4j2s8538hcs95wdpqwxsqvblgf6yhfxdvpa";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "a21c163919cd90dd67bcd03345fac5441e53cccc";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-f3VQSat3L2ObJm7DDr72HFCa9e7WAjKPqW70o2Bb7pg=";
    };
  };
}
