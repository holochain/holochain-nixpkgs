...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "95941d8060ca3148b06673310f5e6b7249dee9ee";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-95941d8060ca3148b06673310f5e6b7249dee9ee/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "ddb20b2426d31e3f9a900558f4978c380ddbf67a";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-ddb20b2426d31e3f9a900558f4978c380ddbf67a/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "6bc5e02b2bcd94568813ab238e3b567c84647b84";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "6bc5e02b2bcd94568813ab238e3b567c84647b84";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-PDVS1L+rfCanIzmtpjouySfeS1UoPGOj/hZzz3POjPA=";
    };
  };
}
