...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "f6973c7ebc11a0b88c03807a8a631128aec4767b";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-f6973c7ebc11a0b88c03807a8a631128aec4767b/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "2182aac936971fcefbf08a1a0c5ef4c81d5e6bdb";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-jq+NsrG6ZAjluxJjxuP2nV6KRxGsaE4RoQ+8HqgmpLo=";
    };
  };
}
