...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "03c1ee5b6c9eb02c8be3a006cd93c1f895188195";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-03c1ee5b6c9eb02c8be3a006cd93c1f895188195/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "ca071d1224442eb0478b3bfe5f7d6b75f205bd2f";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/ca071d1224442eb0478b3bfe5f7d6b75f205bd2f.tar.gz";
      sha256 = "1hpwfl1693f0ncqd96w2kh3acfgwd6wwz1g9q3fj9cisri75b64g";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
