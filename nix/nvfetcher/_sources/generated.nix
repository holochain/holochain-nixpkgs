...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "ee95a2c9b75d68fd0cd1c5b287ce258aa6fcf073";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-ee95a2c9b75d68fd0cd1c5b287ce258aa6fcf073/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "b502950146a6089c3ac017e567899c0b65e649fc";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "b502950146a6089c3ac017e567899c0b65e649fc";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-G6CTgoxZd8yjzPlSCB6+hQ7xLgyMlGkXfvn/W5Y99Q8=";
    };
  };
}
