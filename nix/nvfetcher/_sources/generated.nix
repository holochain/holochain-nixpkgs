...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "dd9e599489b251dd8ca3aaf9ac045d3f53336745";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-dd9e599489b251dd8ca3aaf9ac045d3f53336745/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "6c4ea1e705e497e064ab82fb90ad99a50b15aba8";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-R/Zp+fQ6e0iVTOgcZuXFtnD9O6yjxgdHmCtp3g+zz78=";
    };
  };
}
