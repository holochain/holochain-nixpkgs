...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "70eef4d12c6943e26e3e8866d3bc9a24c839bff5";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-70eef4d12c6943e26e3e8866d3bc9a24c839bff5/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "ab8c5552111da73971554ea3d80e473c97b5c650";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-ab8c5552111da73971554ea3d80e473c97b5c650/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c075bd0d8d88a6826b03ede94c66659e80c80e00";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c075bd0d8d88a6826b03ede94c66659e80c80e00";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-0FGSx/zxu+rg7xpVrDCNqrao76JW1CjjGe/ZyjtRtBA=";
    };
  };
}
