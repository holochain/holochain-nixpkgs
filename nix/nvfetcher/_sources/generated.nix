...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "6adca3a4ab0121754be3af019c75a5222c17779a";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-6adca3a4ab0121754be3af019c75a5222c17779a/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "fa45b01f11214ff40b743714843cdcac79d231f5";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-fa45b01f11214ff40b743714843cdcac79d231f5/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "f30da2c2622736aecdccac893666ea23cad90f2d";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/f30da2c2622736aecdccac893666ea23cad90f2d.tar.gz";
      sha256 = "0gbf3kc11lyj7gyjdyhir34rw5pqpf2sdlbglhpw3f0bm13j057n";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "905db21103d646ddc1eb81920e05180e6e2b6734";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-vQ1q6uwx2gKsHbQVhkq17nT8HwUmRbIG8cJVFafNb5s=";
    };
  };
}
