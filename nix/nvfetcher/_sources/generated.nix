...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "e128b40cc144415bef7642e77159e1fe160c782f";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-e128b40cc144415bef7642e77159e1fe160c782f/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "2c44064953f7ff5385aa6d713c50c9406e06e250";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-2c44064953f7ff5385aa6d713c50c9406e06e250/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "877e24dac6687f24a1745af4f0f280ac10b5751d";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/877e24dac6687f24a1745af4f0f280ac10b5751d.tar.gz";
      sha256 = "02n018x8bk5ib0v5za4xnlsyyj86calrzm6m8v5amibj902akxik";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "e8fe203926215842061585a788c5661a8e0426ed";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "e8fe203926215842061585a788c5661a8e0426ed";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-jR1AaxzxtlW+2U7KUN/q+n0H7OY8ZXfueOShbBpNjAc=";
    };
  };
}
