...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "d4f6535c61ca0a5d9e8ce39a8596366f0aa87ad1";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-d4f6535c61ca0a5d9e8ce39a8596366f0aa87ad1/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "9184f5c210376d50d6f2bc0632a2d06549d79bf3";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-9184f5c210376d50d6f2bc0632a2d06549d79bf3/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "f0d8b069143f12ca41174bc80a5bc03cca7be438";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/f0d8b069143f12ca41174bc80a5bc03cca7be438.tar.gz";
      sha256 = "1nq6cp6sqvnf03nnh1s0nimd1qblkm95q5z1vmw4627hfp09c2pb";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "6ca3338755233ddcb9bd4c80ecb17f453cfd0730";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "6ca3338755233ddcb9bd4c80ecb17f453cfd0730";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-qisDNTIfbC7bWMVqpaZWfrPxtkwLemGi2dtiaHK1ikg=";
    };
  };
}
