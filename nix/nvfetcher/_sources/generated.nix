...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "817de9bd07ab41b7087103b55cfd895f4aa68e85";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-817de9bd07ab41b7087103b55cfd895f4aa68e85/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "46bff70ccb4a6f8fd06720d91774f0fdfc017d0b";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-46bff70ccb4a6f8fd06720d91774f0fdfc017d0b/Cargo.lock;
      outputHashes = {
