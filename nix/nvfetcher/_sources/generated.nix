...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "82a14dde0e5238cce34d9826bc8f76cfc3254de3";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-82a14dde0e5238cce34d9826bc8f76cfc3254de3/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "278ecd211a17873905c5de0374fe93e2522ebdb3";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/278ecd211a17873905c5de0374fe93e2522ebdb3.tar.gz";
      sha256 = "1y3xyp5ygzk3g9gz3k92bcavin1pkz8v74r1izkba3s4r62dsbf8";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "bed82617ca9e139ff1374eb49f98d25ca781eb04";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-qk2Y8zpCFLL9eznilJUojDa4ELitZa9V5upc8VBDp2s=";
    };
  };
}
