...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "7d8decf43f039ede1f78b4aa97c5df45ad7d5804";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-7d8decf43f039ede1f78b4aa97c5df45ad7d5804/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "dc5167bbeb7446a964b66e17fb0a924a669d110d";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-dc5167bbeb7446a964b66e17fb0a924a669d110d/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "15463250cb412f95809f22c151725579904812a9";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/15463250cb412f95809f22c151725579904812a9.tar.gz";
      sha256 = "06m8rs33p34kfxy5k21nx9c17mh8w355gqnl6ph28ibdll1vdl90";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "4b600525be94c23b44c42441f33460343fafe7a1";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-6XIQEwmoldCE3lzI54VQxD2tFJoeRsjRMYWkthtGRRw=";
    };
  };
}
