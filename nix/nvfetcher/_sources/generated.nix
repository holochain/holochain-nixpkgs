...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "1b828d02260fbc216694102efaef018488766e70";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-1b828d02260fbc216694102efaef018488766e70/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "70eab96a255ae9b4b82b38ea5ac5c8e5b57e0abd";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-cqP0TzDs3GDRprS6IgVQcWjQ0ynmjQFjYWvp+LE/s6I=";
    };
  };
}
