...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "bc621e3e06e998d35750b2bac6b0e1f0d371c2a2";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-bc621e3e06e998d35750b2bac6b0e1f0d371c2a2/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "1a291fb210f5e9e506339721f3a8a9d5760f3af6";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-1a291fb210f5e9e506339721f3a8a9d5760f3af6/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "10ecf9db483f157d86e03edbae0ba48f613abfa4";
    src = fetchgit {
