...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "5145c6d01051184c1095f335c87ffcf1b8910cdd";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-5145c6d01051184c1095f335c87ffcf1b8910cdd/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "a5f6cb5145da037b81fb66b7fc6e6de6b29a64b2";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-a5f6cb5145da037b81fb66b7fc6e6de6b29a64b2/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "3e201ab3def035c018641a948bb2912e99e03a37";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/3e201ab3def035c018641a948bb2912e99e03a37.tar.gz";
      sha256 = "0gxbdj59p64z2gkg1hqm8ag46j9g0nrrmg5xy6kaw2hsf82k3zia";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "453070deaba6d2157103e269f46b752435bec266";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "453070deaba6d2157103e269f46b752435bec266";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-1tw/CwsP5gi/J0CewA9aKG4FsczXEzCckrnnx4dIFA0=";
    };
  };
}
