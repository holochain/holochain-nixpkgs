...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_main = {
    ...
    version = "841a38e3e1a5b9368712e61a80d6f29e7eb2c310";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-841a38e3e1a5b9368712e61a80d6f29e7eb2c310/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "1b4722674c315de0e191d0d79790b4eac51570a1";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/1b4722674c315de0e191d0d79790b4eac51570a1.tar.gz";
