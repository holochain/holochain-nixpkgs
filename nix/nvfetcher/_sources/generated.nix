...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "468eb28d493fba411fe19c116570e7481a83bb6d";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-468eb28d493fba411fe19c116570e7481a83bb6d/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "c7188074993f347e15f361dde801cab5e02b4a10";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/c7188074993f347e15f361dde801cab5e02b4a10.tar.gz";
      sha256 = "0017s2jk03crbifj6js0128fl7hmv4v0yvsnq61ypp5xrdxpma9k";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "8cb3e0b16287177c909e01ccb3e2485ec9c01f87";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "8cb3e0b16287177c909e01ccb3e2485ec9c01f87";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-7pjmBoFzaoKn/oLD6sMBNVy0HCvRyAdUA5nZ68v5pw8=";
    };
  };
}
