...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "bbadea72189ae9ec8ef2326527607e1162deb003";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-bbadea72189ae9ec8ef2326527607e1162deb003/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "b2eb2342d2feb68872e19636e83d199d38b01f66";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-b2eb2342d2feb68872e19636e83d199d38b01f66/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "f53c984ce9b469a729fa08df1f5d3c5b4f8eb5e3";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/f53c984ce9b469a729fa08df1f5d3c5b4f8eb5e3.tar.gz";
      sha256 = "1aw5jgqc31x57gcbk36dkm0ax7b2a5z87si7c9bn50qd7rwigrga";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "7f599870402c8d2a5806086c8ee0f2d92b175c54";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-2drCXIKIQnJMlTZbcCfuHZAh+iPcdlRkCqtZnA6MHLY=";
    };
  };
}
