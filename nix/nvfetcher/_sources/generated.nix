...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "36747085f450672f1aa43e029171e5bc678baac8";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-36747085f450672f1aa43e029171e5bc678baac8/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "573603b7fdb9feb0eb8efc16ee18a015c667ab1b";
    src = fetchTarball {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "69133a80f7c1d13231e246a911aaad57d8dcd584";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-dbPb5ddWfkACYNHZSIfxXYzLCLmApGd/n9jZnU5tayU=";
    };
  };
}
