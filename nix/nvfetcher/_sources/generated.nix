...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "03f315be92991f374cba341d210340f7e1141578";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-03f315be92991f374cba341d210340f7e1141578/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c91265a3f0d28b3b1ad60a47c4764a45b111ed4b";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c91265a3f0d28b3b1ad60a47c4764a45b111ed4b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-kkl0U9OXMfzSKZX8rF/zSDMBHwzt7st32dyUqJGYNwU=";
    };
  };
}
