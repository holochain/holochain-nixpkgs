...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "11c65d20e046580e38c90610bb6e15732ab07764";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-11c65d20e046580e38c90610bb6e15732ab07764/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "7f204047c56a2c165b1442cd480828a03caadde2";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-7f204047c56a2c165b1442cd480828a03caadde2/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "d9be95a45f8ae428aaa6e78e874ba6f3100ed38a";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/d9be95a45f8ae428aaa6e78e874ba6f3100ed38a.tar.gz";
      sha256 = "1cw2y4lqdmbf82nlwsazvxxb2bd7m0i0lx1czhgzhj6dwccy4r0j";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "e04a88d7f859ae9ec42267866bb68c1a741e6859";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "e04a88d7f859ae9ec42267866bb68c1a741e6859";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ApxncWKkIIrckV851+S6Xlw7yO+ymLOp0h7De+frCT8=";
    };
  };
}
