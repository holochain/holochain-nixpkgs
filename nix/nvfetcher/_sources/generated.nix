...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "544e9c8893c5b30d0db661744fe4c86c7a0431ae";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-544e9c8893c5b30d0db661744fe4c86c7a0431ae/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "9774dc9f913cd274016b9d209167931c1a04ef46";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/9774dc9f913cd274016b9d209167931c1a04ef46.tar.gz";
      sha256 = "0g6q7bfzc3xc6midpcxhhzxa33zfmrg56j9r9p4scwca3lbkc0fx";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
