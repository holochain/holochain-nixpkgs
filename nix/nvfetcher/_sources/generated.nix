...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_main = {
    ...
    version = "cf8adc073596f4f5fc3dcf31c30bc8ade47a6f93";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-cf8adc073596f4f5fc3dcf31c30bc8ade47a6f93/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "dbd08f5b5469e1e24f00de45ddc73c26290a2bcb";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DpqF/1FYpUo3Fm54oBaXzdqIG7BuRkHHFOgLM0uVVF0=";
    };
  };
}
