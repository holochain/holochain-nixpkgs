...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "2f916e72c6f0cf45fb1303d2beb7143b0d9c8321";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-2f916e72c6f0cf45fb1303d2beb7143b0d9c8321/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "6eb90123f46664ffbb550c527f656ba848718af5";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "6eb90123f46664ffbb550c527f656ba848718af5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-HwsSRFWxD9G3PxOjlIARuN/v4TnhK3ZkaVeyVCYrBBE=";
    };
  };
}
