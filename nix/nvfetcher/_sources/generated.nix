...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "42f8ecc3a0f5fe7a8937ce50fdebbce49af71880";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-42f8ecc3a0f5fe7a8937ce50fdebbce49af71880/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "09e8ac77744dd036e58ab2284e6f5c03a6d6ed41";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/09e8ac77744dd036e58ab2284e6f5c03a6d6ed41.tar.gz";
      sha256 = "06fvx6vxc2rlykhsrny63xaam8y8i0wcr20vfncy72vzwck1pjsv";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
