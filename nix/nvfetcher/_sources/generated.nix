...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "860e0b2a658fd46330475b11119d5f1e6f792be6";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-860e0b2a658fd46330475b11119d5f1e6f792be6/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "f5ed345047cf8c5ade22bc81e45adb5c0a525747";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/f5ed345047cf8c5ade22bc81e45adb5c0a525747.tar.gz";
      sha256 = "05bz5g3q8dan6ssmsfqs28zxihxacvvi9vhny29hf8kf7zwpl09z";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "25a0cef768d8cb6071002f81ec38f99e350f5653";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "25a0cef768d8cb6071002f81ec38f99e350f5653";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-rq0ziY2vnwrao5XzOQt09evgrzWJAWoUMGq+4onsoDs=";
    };
  };
}
