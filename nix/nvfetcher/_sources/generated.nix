...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "5ff46252a7521c101ac6360591961eaf029367a1";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-5ff46252a7521c101ac6360591961eaf029367a1/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "5a3499e427191083853c64dcdfe073d7e7d89de9";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/5a3499e427191083853c64dcdfe073d7e7d89de9.tar.gz";
      sha256 = "0gizsd04mjlhjbc0jxlgb73zn6a8p0zlzg2b2n2s4aahiv6n2svf";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "18c816d2d10317f4a8816925a12cb4bbdd0821de";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-anMSkIvaxB3jV74nTvPcE8fH7bZ5LPuc2wXGvt50Oe0=";
    };
  };
}
