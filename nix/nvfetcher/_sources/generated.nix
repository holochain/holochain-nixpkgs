...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "cd253bf0b2b8bd8c3d69c3b8f02c9397249e7da1";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-cd253bf0b2b8bd8c3d69c3b8f02c9397249e7da1/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "0cd777c789ee13ca655f9bffbd7fe11b49e47824";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-0cd777c789ee13ca655f9bffbd7fe11b49e47824/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "12aa8ea4381b28b7a3118f96682dc3ffb13fb6b6";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DqMtTtIownl+UIPG1O917IH10UF0Hwql636p22vOJfw=";
    };
  };
}
