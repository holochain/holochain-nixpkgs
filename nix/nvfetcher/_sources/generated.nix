...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "fa01016770f7f259a5fa4fa11c0927de2a433530";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-fa01016770f7f259a5fa4fa11c0927de2a433530/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "f1a6870b6edfd259bc58a57814b0cc3e95205040";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-f1a6870b6edfd259bc58a57814b0cc3e95205040/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "ab4d2623fe20ac2a8e6128567148664ad91ed9d0";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "ab4d2623fe20ac2a8e6128567148664ad91ed9d0";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-M8JyQzyQfv3nilWGKGBLrsnRl8E4JtjHv40AWW1rZ+0=";
    };
  };
}
