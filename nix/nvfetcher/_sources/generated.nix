...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "bea5e520debcd691e67065517f6f8f012f56a27b";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-bea5e520debcd691e67065517f6f8f012f56a27b/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "6277dfd6eedc873889a4fccb8e5f33c72e3f2b47";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-6277dfd6eedc873889a4fccb8e5f33c72e3f2b47/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "f9115594149ebcb409a42e303bec4956814a8419";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/f9115594149ebcb409a42e303bec4956814a8419.tar.gz";
      sha256 = "0723wvrzwbn1mh5y64i59mcghdkpfw8yzivcqlphiradxbcnq0qc";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "af2e939ba2c7cbb188d06d6650c6353b10b3f2be";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4mmm+1MBPMD56LMLN9QcEwnfnu41NkA6lDeZGjSrxIw=";
    };
  };
}
