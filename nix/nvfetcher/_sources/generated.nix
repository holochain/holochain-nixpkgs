...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "c87250935f953db5be4ed44ed7000fc864beac91";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-c87250935f953db5be4ed44ed7000fc864beac91/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "b41b858235faa68103cd25ad9b6248132d6a829b";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "b41b858235faa68103cd25ad9b6248132d6a829b";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-v6aqBnxVziSzfI3DpGD+6m1XoFnYEYzykkdY/bUwJJ0=";
    };
  };
}
