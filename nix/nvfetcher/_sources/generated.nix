...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_main = {
    ...
    version = "0c83eef081272e7a6bc9a4c72d3c848eb7d2f57f";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-0c83eef081272e7a6bc9a4c72d3c848eb7d2f57f/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "b4fb0f8454fe4e6ebb0a564a28a87cc88cc3cb2c";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-w9Eb0xAIVqlg3E1I1QAXyc4RvQrLUN0Uwce0OwQWIQU=";
    };
  };
}
