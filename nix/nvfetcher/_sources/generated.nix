...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "cd233dc38b0b6cd4e559530bc4e611333bf1294b";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-cd233dc38b0b6cd4e559530bc4e611333bf1294b/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "14269ee3f81ca20f72d26dc0fb7ffb5c4e598e10";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/14269ee3f81ca20f72d26dc0fb7ffb5c4e598e10.tar.gz";
      sha256 = "0ijfngx1bmf1m6xr6a08z86dkr81hgjfzznpvicdvnala2v6wksi";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "3b4e68f5949221922189ebc887cde270e98956a9";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "3b4e68f5949221922189ebc887cde270e98956a9";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-l15nzQRveoVcrxQh9ASsqy++d4iM1HWfZU1uJf6b0EU=";
    };
  };
}
