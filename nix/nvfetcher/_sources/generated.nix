...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "285329ba52fc690238f7f9d8d90039c0fa38e627";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-285329ba52fc690238f7f9d8d90039c0fa38e627/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "60c2cfaa8b90ed8cebd18b214fac8682dcf222dd";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Gpf2gp2JenKGf+TylX/YJpttY2bzsnvAMLdLaxoZRyU=";
    };
  };
}
