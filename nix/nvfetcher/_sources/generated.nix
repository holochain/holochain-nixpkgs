...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "a8a2e843c3f2f22151de81f36d2c567797774278";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-a8a2e843c3f2f22151de81f36d2c567797774278/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "a65e63f15f1889c053f833767c7d624ccfba3110";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "a65e63f15f1889c053f833767c7d624ccfba3110";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-0rhe0dv2XVUfh8DTkmqyXURThKKqnEtsBZ3LITYhIf8=";
    };
  };
}
