...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "b1e8406e746b821f98389ddd79d2e3fcd6c627e8";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-b1e8406e746b821f98389ddd79d2e3fcd6c627e8/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "81f5b97a326b597e523dd3490d1af50400e4d001";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/81f5b97a326b597e523dd3490d1af50400e4d001.tar.gz";
      sha256 = "11n2jn1q2b5siknwww0plz8bp1jccznf6b7af36s0faxjqri9g1d";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
