...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "9b38b2d8405696af7b4ca739f28373bb76f7d1ae";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-9b38b2d8405696af7b4ca739f28373bb76f7d1ae/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "c285dacbce84237774a294b0ac76698ade82d543";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-c285dacbce84237774a294b0ac76698ade82d543/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "16f4e04658c2ab10114545af2f39db17d51bd1bd";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/16f4e04658c2ab10114545af2f39db17d51bd1bd.tar.gz";
      sha256 = "1mm15cfxbackcidzmykv0kcfdgmjykjcr8s0pyydp6m3mc4dda8y";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "f0bfcaebb0cfcbfa2e76d0925cca845d73b83d38";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "f0bfcaebb0cfcbfa2e76d0925cca845d73b83d38";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-xMOq9ifVo63/aBA1VIHQQ4riuRJGyup7F1orjekAwpk=";
    };
  };
}
