...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "b60132cfa8a1d3ed7e61e11990606471cfa26d48";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-b60132cfa8a1d3ed7e61e11990606471cfa26d48/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "db9443ca1384f94c0aa63f4e74115f7c0632a8e6";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Mp7LmSPnRfWqX7OElXr4HKNbTiDCXLaxijp23xQlDJk=";
    };
  };
}
