...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "ce2b95ef06c3dfb58b4a6536d4696af2423ef8af";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-ce2b95ef06c3dfb58b4a6536d4696af2423ef8af/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "005c15c06404f41baa77e4533a32cef93a69ed3b";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-005c15c06404f41baa77e4533a32cef93a69ed3b/Cargo.lock;
      outputHashes = {
