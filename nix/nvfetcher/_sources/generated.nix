...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "0a9973bcc425b419afafd7a2d03d9713756b5c2f";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-0a9973bcc425b419afafd7a2d03d9713756b5c2f/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "e9364427f6ebe1a7f3a8d75d252fd8445c039f2a";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-e9364427f6ebe1a7f3a8d75d252fd8445c039f2a/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "4f09cfce9c1d54fb56b65125061a632849de1a49";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/4f09cfce9c1d54fb56b65125061a632849de1a49.tar.gz";
      sha256 = "1aw4kyhrrb3dmy4hb606jjq5jjl5vxwy8hmqknl4pf5fsbfgqg1l";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "e59127e7691e2becba08cd6fe59bce447221a679";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "e59127e7691e2becba08cd6fe59bce447221a679";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-mQHXO6FN32r+W16onsa+ewAbl2qAG+JV6ONt9UwlIrg=";
    };
  };
}
