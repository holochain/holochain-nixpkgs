...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "f5a832e33c50f4a2e3aef534d84bf6e21f338ccb";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-f5a832e33c50f4a2e3aef534d84bf6e21f338ccb/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "377be199339179d02502a817ad8babe23f89a7bc";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-377be199339179d02502a817ad8babe23f89a7bc/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "7a5ca644cc5e96336e7717aca871f01320c2df09";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/7a5ca644cc5e96336e7717aca871f01320c2df09.tar.gz";
      sha256 = "1qkvbl5fyckdi56nrhash410wb15f0hjjiqnw0nncrv031iak9d0";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
