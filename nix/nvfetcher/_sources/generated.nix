...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "e1d23e2ac8cefc79a988feeccdfc3ed7a994b4d7";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-e1d23e2ac8cefc79a988feeccdfc3ed7a994b4d7/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "15cd34f33ffc2576258c6bf33d1da427ab86e851";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-15cd34f33ffc2576258c6bf33d1da427ab86e851/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "5066af8707c4b598ad2dbfb2fdac73714bee3438";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Rtut6Q81u1pDS3Y44Syhy436IrESmvPCdGDtl47E4eo=";
    };
  };
}
