...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "00ba93828ea870e1628be6cc1496b3b460b36ca2";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-00ba93828ea870e1628be6cc1496b3b460b36ca2/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "6266af0f970a5282c876aa0c261a59d4c62010be";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/6266af0f970a5282c876aa0c261a59d4c62010be.tar.gz";
      sha256 = "0h1m1xkrbbk3bdmhdkq46lh3wpa78i1xssriz3h6nzqwgyd6yph0";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "609f28f58c849c31b6a49fa1a75a72b08962ba62";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Ly+9jnoRtRvSOB2KfNIxP+VlqoJZ+Iz2doeItuqY29s=";
    };
  };
}
