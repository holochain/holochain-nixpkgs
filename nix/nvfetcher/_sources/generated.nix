...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "f459cd5710559c2d5ac6e4f9cd713d20b06a82ad";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-f459cd5710559c2d5ac6e4f9cd713d20b06a82ad/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "6900ec9f9c0e95c3af835b6e56ec77a74d924000";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-6900ec9f9c0e95c3af835b6e56ec77a74d924000/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "e864fb6110f541415828aba58ebc0d524a1af776";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/e864fb6110f541415828aba58ebc0d524a1af776.tar.gz";
      sha256 = "19qkak9mn41ps03rakfsz9c5mgb0zz81hhv56znwyiv71yqscjl4";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "00ac40d23ec331be4fd143b8cd3e9142e3bcbe9b";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-wQ/xUt2yU+ncx0JQMMQDcFoWLY2xo0Vo5CxIGuxMdmY=";
    };
  };
}
