...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "631cbf4c745333a50d1aabd8cfdc72153c785aa9";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-631cbf4c745333a50d1aabd8cfdc72153c785aa9/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "70d8df25fbe9cc5c74900b11d06ef120200f3948";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "70d8df25fbe9cc5c74900b11d06ef120200f3948";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-lpkekAbs8FNoqpbxuMpkdNMiRnWxDyvAyR+pWxW2PTs=";
    };
  };
}
