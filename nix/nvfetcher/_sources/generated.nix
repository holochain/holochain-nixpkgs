...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "037228d0514f59689fd2b50ff5ba66eb1a214307";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-037228d0514f59689fd2b50ff5ba66eb1a214307/Cargo.lock;
      outputHashes = {
  ...
  holochain_revision_holochain-0_0_134 = {
    pname = "holochain_revision_holochain-0_0_134";
    version = "holochain-0.0.134";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_revision_holochain-0_0_134-holochain-0.0.134/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "83f4403210afff3a25f82789b18967ed75869f9c";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/83f4403210afff3a25f82789b18967ed75869f9c.tar.gz";
      sha256 = "1xsa2bx8vmrapma0qv33s5aaa0ahxpj7ls5izndhqvkidmh473hg";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "80868ba348db2b5e733483454cbb5770f2951077";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "80868ba348db2b5e733483454cbb5770f2951077";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-1OxFtYEQKcMxSSyluPqs4LApaYMudyPjqISTILfmtLU=";
    };
  };
}
