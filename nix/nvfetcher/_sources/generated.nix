...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "ba1771f31dfe3fb10c47dd5f00ed255a417c5580";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-ba1771f31dfe3fb10c47dd5f00ed255a417c5580/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "850c27142ac01525b751e2c9d97138fe5d8a0ad0";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/850c27142ac01525b751e2c9d97138fe5d8a0ad0.tar.gz";
      sha256 = "1icfw3bxp3b1idz7v2kzmphn3rghfjps81gdkjbw0rws17hmfcs6";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "0dcfaaf2b1e2b00f3fa3ce9d4019508fbc12d93e";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "0dcfaaf2b1e2b00f3fa3ce9d4019508fbc12d93e";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-yyCGs+uebvYg7Og1QWmZkvj1SF5ZV2tchXvY43dpjMA=";
    };
  };
}
