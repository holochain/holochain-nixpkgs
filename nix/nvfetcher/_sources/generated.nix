...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "58a9a102b47e0af4cd4e61311da788ba0ce34830";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-58a9a102b47e0af4cd4e61311da788ba0ce34830/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "34dd07a5d195f33b7060468c854b0199b5f7b232";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "34dd07a5d195f33b7060468c854b0199b5f7b232";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DotGgzHOm+MQjoCyOG56n02HBpTak1s7yDH9gyNI8ME=";
    };
  };
}
