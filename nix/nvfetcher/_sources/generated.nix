...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "a9ee3b8e20e78a32fb63fbf0ef73b91617e95695";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-a9ee3b8e20e78a32fb63fbf0ef73b91617e95695/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "93c9b64c8852162c62267d8d8ef9a58e0d3aa57c";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-93c9b64c8852162c62267d8d8ef9a58e0d3aa57c/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "1cad1a76223cfaaaa5486e90c1089107294080ee";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/1cad1a76223cfaaaa5486e90c1089107294080ee.tar.gz";
      sha256 = "02klbifallbly7a6s4fkjcsfc16b3sdhzizzw91radjpn9m82vcz";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "94d6aee5c4241cf7fa3f6564608a04c796cbb412";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "94d6aee5c4241cf7fa3f6564608a04c796cbb412";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-iYM1KAnSW93KeP9gpacmv+IoqU+6mmwqvdBP/JLL7XE=";
    };
  };
}
