...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "9426206f457d0ecd807892863670c77f37bd831d";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-9426206f457d0ecd807892863670c77f37bd831d/Cargo.lock;
      outputHashes = {
  ...
  rust-overlay = {
    pname = "rust-overlay";
    version = "c1e8d766436179b622af088b3dbf1181264c18ba";
    src = fetchgit {
      url = "https://github.com/oxalica/rust-overlay";
      rev = "c1e8d766436179b622af088b3dbf1181264c18ba";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-LSfDnzZ55gqpd2FIKuxcvMu2K6cedmV0CbfECph+VnE=";
    };
  };
}
