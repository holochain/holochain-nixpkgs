...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  holochain_branch_develop = {
    ...
    version = "514596c1720bf26530c36478ccc1a87a119ca5e0";
    src = fetchgit {
    ...
    cargoLock = {
      lockFile = ./holochain_branch_develop-514596c1720bf26530c36478ccc1a87a119ca5e0/Cargo.lock;
      outputHashes = {
  ...
  holochain_branch_main = {
    ...
    version = "7a271935089e2d91c5e3773523b9fd996c3ed4b7";
    src = fetchgit {
      url = "https://github.com/holochain/holochain";
    ...
    cargoLock = {
      lockFile = ./holochain_branch_main-7a271935089e2d91c5e3773523b9fd996c3ed4b7/Cargo.lock;
      outputHashes = {
  ...
  nixpkgs = {
    pname = "nixpkgs";
    version = "42e11fb96ed365de6f4fa07306811e97cbb29c7a";
    src = fetchTarball {
      url = "https://github.com/nixos/nixpkgs/archive/42e11fb96ed365de6f4fa07306811e97cbb29c7a.tar.gz";
      sha256 = "1dkhkiqz5ac6g16hrsb1mpsnfnx8qq07svsk4x2rqa084a4k6dzg";
    };
  };
  nvfetcher = {
    pname = "nvfetcher";
