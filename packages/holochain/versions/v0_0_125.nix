...
# update-holochain-versions --nvfetcher-dir=nix/nvfetcher --output-file=packages/holochain/versions/v0_0_125.nix --git-src=revision:holochain-0.0.125 --lair-version-req=~0.0
